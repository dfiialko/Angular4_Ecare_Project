...
export class PatientsComponent implements OnInit {
  ...
  users: Array<Patient> = [{email: 'peter@gaied.com', name: 'Peter Gaied', birth: '09/09/1990', phone: '2042242828' },
                           {email: 'goAwayMike@gaied.com', name: 'Mike Ooe', birth: '09/09/1990', phone: '2042242828' },
                           {email: 'goAwayMike@gaied.com', name: 'Mike Ooe', birth: '09/09/1990', phone: '2042242828' }]
