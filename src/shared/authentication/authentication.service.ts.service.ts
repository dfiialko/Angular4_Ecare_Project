...
export class AuthenticationService {
    ...
    // This event if triggered on Login Click event from Login Page.Once passed javascript validation it sends
    // http request to the server to get access and refresh token.
    ...
    // Save access and refresh token into local storage.
    ...
    // Send the refresh token in order to obtain new access and refresh token
    refresh() {
